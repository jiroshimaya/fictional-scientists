...
- 生年・没年の表記は時代に合わせて自然に記述する
  - 古代・中世（〜1399年頃）: 「紀元前3世紀頃」「〇〇年頃」「不明」など概数・不明が自然
  - 1400–1799年頃: 年単位がわかることもあるが「〇〇年代頃」「〇〇年頃」も可
  - 1800年以降: 年単位で記録されることが多い
  - 与えられた生年の数値はあくまで目安として扱い、時代に応じて「〜頃」や「不明」に変えてよい
