...
### エウクラテス（紀元前4世紀後半頃 - 紀元前320年頃）
- 古代ギリシア
- 自然哲学: 自然界の四元素説とその変容過程に関する哲学的考察

![](../data/result/era_only_13/portraits/古代前期__自然哲学__古代ギリシア__0001.png)

### セレーネ・バクトリス（紀元104年頃 - 紀元140年頃）
- アレクサンドリア・エジプト圏
- 天文学・宇宙論: 星辰の運動と季節変化の数学的体系化による宇宙構造の探究

![](../data/result/era_only_13/portraits/古代後期__天文学・宇宙論__アレクサンドリア・エジプト圏__0001.png)

### ナディール・アル＝バラク（10世紀初頭頃 - 10世紀中頃頃）
- イスラム世界
- 数学・幾何学: 非ユークリッド的視点を用いた多角形の内角和の理論的拡張

![](../data/result/era_only_13/portraits/中世前期__数学・幾何学__イスラム世界__0001.png)

### 沈蕙蘭（宋の建寧年間頃（1119年頃） - 不明）
- 宋元中国圏
- 暦法・観測学: 実践的天文観測器の改良と暦法の地域差是正に関する考察

![](../data/result/era_only_13/portraits/中世後期__暦法・観測学__宋元中国圏__0001.png)

### アルビーノ・ディ・ヴェローナ（1411年頃 - 1468年頃）
- イタリア諸邦
- 光学: 光の屈折率変化に基づくレンズ設計と視覚拡大理論の構築

![](../data/result/era_only_13/portraits/ルネサンス・初期近世__光学__イタリア諸邦__0001.png)

### Katherine Wycliffe（1650年代頃 - 1710年代頃）
- イングランド
- 力学: 斜面における物体の運動法則の系統的実験検証による摩擦概念の深化

![](../data/result/era_only_13/portraits/近世前期__力学__イングランド__0001.png)

### ルイ・ヴァラン（1758年頃 - 1823年頃）
- フランス
- 熱学・統計物理: 蒸気圧と温度分布の統計的関係に基づく熱力学初歩の数学的定式化

![](../data/result/era_only_13/portraits/近世後期__熱学・統計物理__フランス__0001.png)

### エミーリエ・クロイツァー（1810年 - 1876年）
- ドイツ
- 電磁気学: 電磁誘導の時間依存性と磁力線の空間分布解析

![](../data/result/era_only_13/portraits/近代前期__電磁気学__ドイツ__0001.png)

### 高橋 拓真（慶応3年（1867年）頃 - 昭和12年（1937年））
- 日本
- 実験物理: 分光器を用いた金属固有振動数の実験的測定とその電磁理論への応用

![](../data/result/era_only_13/portraits/近代後期__実験物理__日本__0001.png)

### Evelyn Marlowe（1939年 - ）
- 米国
- 理論物理: 場のトポロジー欠陥を用いた非線形量子重力理論の理論構築

![](../data/result/era_only_13/portraits/現代前期__理論物理__米国__0001.png)

### レオニード・マルチェンコ（1954年 - ）
- ソ連・ロシア
- 原子核物理: 中性子散乱による超重元素合成過程の物理的特性解明

![](../data/result/era_only_13/portraits/現代中期__原子核物理__ソ連・ロシア__0001.png)

### 何 慧琳（1982年 - ）
- 中国
- 量子情報・量子技術: 量子通信の耐エラー符号と大規模ネットワークへの応用研究

![](../data/result/era_only_13/portraits/現代後期__量子情報・量子技術__中国__0001.png)

### アニル・スリヴァスタヴァ（2007年 - ）
- インド
- 計算物理: 異種スケール結合による多体系量子シミュレーション手法の創案

![](../data/result/era_only_13/portraits/現代最年少__計算物理__インド__0001.png)

## まとめ
肖像画像まで含めて、ある程度理想に近いものが生成できました。
架空の人物やキャラクターを大量に生成すると、無難で似たりよったりのデータができてしまうことが懸念ですが、今回は、事前に属性をある程度固めておいたことで、バリエーションが出せたと思います。
